const PreguntasFrecuentes = () => {
  return (
    <main className='d-flex align-items-centerp'>
      <div className='container-fluid col-11 col-xl-10 col-xxl-9 my-3 bg-white py-2'>
        <div className='container-fluid d-flex flex-column align-items-center col-md-9'>
          ...
          <div className='text-center'>
            ...
            <p>
              De igual manera, siempre tienes la posibilidad de escribirnos al <a href='#'>mail</a> o hablarnos por <a href='#'>whatsapp</a>!
            </p>
