...
const MisPublicaciones = () => {
      ...
      <>
        <div className='bg-white border d-flex flex-row align-items-center justify-content-center'>
          <div className='d-flex flex-column align-items-center py-5'>
            ...
            <h3>Aun no tienes ninguna publicación</h3>
            <h5 className='pb-4'>Puedes crear una y empezar a vender cuando quieras</h5>
            <button type='button ' className='btn btn-secondary col-4 me-auto ms-auto' onClick='/'>Crear Publicación</button>
          </div>
        </div>
      </>
  ...
  return (
    <main className='d-flex align-items-center'>
      <div className='container-fluid col-9 my-5'>
